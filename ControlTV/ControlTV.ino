...
/*--------------------   MEGACABLE   -----------------------------*/
/*
unsigned long powerCode = 0xCD323BC4; // Código IR para encender/apagar
unsigned long volumeUpCode = 0xCD3201FE; // Código IR para subir volumen
unsigned long volumeDownCode = 0xCD32817E; // Código IR para bajar volumen
unsigned long channelUpCode = 0xCD32A15E; // Código IR para subir canal
unsigned long channelDownCode = 0xCD32619E; // Código IR para bajar canal
unsigned long muteCode = 0xCD3239C6; // Código IR para silenciar

unsigned long sourceCode = 0xE0E0807F; // Código IR para home
unsigned long upCode =0xCD3253AC ; // Código IR para arriba
unsigned long downCode = 0xCD324BB4  ; // Código IR para abajo
unsigned long leftCode = 0xCD329966  ; // Código IR para izquierda
unsigned long rightCode = 0xCD32837C  ; // Código IR para derecha
unsigned long okCode = 0xCD32738C  ; // Código IR para ok
unsigned long backCode = 0x2FDFF00 ; // Código IR para regresar

unsigned long playPauseCode = 0xCD32A956 ; // Código IR para play/pause

unsigned long exitCode = 0xCD32A35C  ;

unsigned long menuCode = 0xCD3211EE    ; // Código IR para Netflix
unsigned long disneyCode = 0x3A00 ; // Código IR para Disney+
*/

/*-------------------------   LG   -----------------------------*/
unsigned long powerCode = 0x20DF10EF;       // Código IR para encender/apagar
...
unsigned long sourceCode = 0x20DF3EC1;      // Código IR para home
unsigned long upCode = 0x20DF02FD;          // Código IR para arriba
unsigned long downCode = 0x20DF827D;        // Código IR para abajo
unsigned long leftCode = 0x20DFE01F;        // Código IR para izquierda
unsigned long rightCode = 0x20DF609F;       // Código IR para derecha
unsigned long okCode = 0x20DF22DD;          // Código IR para ok
unsigned long backCode = 0x20DF14EB;        // Código IR para regresar
unsigned long playPauseCode = 0x20DF0DF2;   // Código IR para play/pause
unsigned long exitCode = 0x20DFDA25;        // Código IR para salir
unsigned long menuCode = 0x20DFC23D;        // Código IR para menú
unsigned long netflixCode = 0x20DF6A95;     // Código IR para Netflix
unsigned long disneyCode = 0x20DF3AC5;      // Código IR para Disney+
